...
" Python 
call s:h("pythonFuncName",          { "fg": s:green })
call s:h("pythontThis",              { "fg": s:pink })
call s:h("pythonFunctionKey",       { "fg": s:green })
call s:h("pythonExceptions",        { "fg": s:aqua })
call s:h("pythonFutureKeys",        { "fg": s:aqua })
call s:h("pythonBuiltins",          { "fg": s:aqua })
call s:h("pythonArgsObj",           { "fg": s:aqua })
call s:h("pythonStatic",            { "fg": s:aqua })
call s:h("pythonSuper",             { "fg": s:aqua })
call s:h("pythonFuncArgRest",       { "fg": s:purple, "format": "italic" })                                 
call s:h("pythonFuncArgs",          { "fg": s:orange, "format": "italic" })
call s:h("pythonStorageClass",      { "fg": s:aqua })
call s:h("pythonDocTags",           { "fg": s:aqua,   "format": "italic" })
